    ...
    upgrades = [
        {
            // Bob's
            name: 'Auraven',
            quote: 'Your grandmas have successfully mastered the art of baking, and are now able to use their aura to aid them in the process.',
        ...
        // Bob's
        {
            ...
            quote: "Before you were using humans to work in your factories, but now you're using Nameks. Your productivity has increased by over 9000 percent!",
        ...
        },
        {
            ...
            quote: 'After many years of devoting themselves, the followers have started to awaken a power called aura. Praying while cultivating it pleases the gods even more.',
        ...
        // Bob's
        {
            ...
            quote: 'Apparently by converting aura you get about twice the amount of mana. Gonna have to fire some people for that one.',
        ...
        },
        {
            ...
            quote: 'Having no need for aura themselves, your astronauts distilled it into their fuel, making it even more efficient.',
        ...
        {
            name: 'Qi-kies',
            quote: 'Through your vast comprehension of the alchemical laws, you are now able to create cookies from your own qi – qi-kies, if you will.',
        ...
        // Bob's
        {
            ...
            quote: 'By creating portals from qi, it seems that you can travel inside yourself. A little odd, but more cookies nonetheless.',
        ...
        },
        {
            name: 'Aura dice',
            // Bob's
            quote: "Yes, you've found a way to use your understanding of the world to affect your luck and get more cookies. *sigh* Don't you think you have enough luck already?",
        ...
        },
        {
            // Bob's
            name: 'Auraverse',
            quote: "It is said that when one's understanding of the Martial Dao gets too profound, an ocean starts forming inside of his own body, eventually becoming a full-fledged world.",
...
export const haloIdleverseDesc = (): string =>
    `I must've called about ${Beautify(Game.cookiesPs)} times.`;
const halo = (): ICreateTieredUpgradeDTO[] => {
    ...
    upgrades = [
        ...
        },
        {
            ...
            quote: "These'll be sure to provide good lighting to all those workers throughout the nigh- I mean, when they need it in their law-abiding work hours.",
            building: buildings.factory,
            tier,
        },
        {
        ...
        },
        {
            ...
            // Bob's
            quote: '... and the factor of holiness per halo condensed is a function where n is the number of halos and g is the universal condescension constant, 2^ng.',
            building: buildings.antimatterCondenser,
            tier,
        },
        // Bob's
        {
            ...
            quote: "A halo also gives off light, doesn't it? I guess at this point it doesn't really matter, you'll find a way to make cookies with them.",
            building: buildings.prism,
            tier,
        },
        // Bob's
...
const luminous = (): ICreateTieredUpgradeDTO[] => {
    ...
    upgrades = [
        ...
        {
            name: 'Luminous seeds',
            quote: "Through your advancements in the field of agriculture, you've discovered some sort of luminescent seed. It's still unclear whether it's safe or not, but it yields more crops than normal ones.",
            building: buildings.farm,
            tier,
        },
        {
            name: 'Luminous refining',
            quote: 'By mixing the cookie dough you mine with a mysterious luminescent powder, you are able to make them yield more and become tastier.',
            building: buildings.mine,
            tier,
        },
        {
            name: 'Luminous labor',
            quote: "By doing some shenanigans to a strange luminous powder that was recently discovered, you managed to create an entirely new workforce. They're fast, efficient and don't need to rest!",
            building: buildings.factory,
            tier,
        },
        {
            name: 'Luminous cash',
            quote: "You've created a new currency coated in a strange luminous powder. You don't really know what it is or where it came from, but gold is shiny, so it's obviously more valuable, right?",
            building: buildings.bank,
            tier,
        },
        {
        ...
        },
        {
            ...
            quote: 'Wizards have discovered that by condensing mana, they are able to make a mysterious luminescent powder. This, in turn, is highly effective as a catalyst when using spells.',
            building: buildings.wizardTower,
            tier,
        },
        {
            name: 'Luminous fuel',
            quote: 'By mixing normal fuel and a solution of a mysterious luminous powder and alchohol, it becomes highly more potent.',
            building: buildings.shipment,
            tier,
        },
        {
        ...
        },
        {
            ...
            quote: "By using a strange luminous powder in your time machines, you can know where exactly you're going in spacetime more precisely. Yes, it works. Don't ask how.",
            building: buildings.timeMachine,
            tier,
        },
        // Seriously?
        ...
        {
            name: 'Luminous prism',
            quote: "Well, you convert light into cookies. So if the prism is coated in luminous powder it'll obviously create more cookies.",
            building: buildings.prism,
            tier,
        },
        {
        ...
        },
        {
            ...
            quote: 'Brand new galaxies to explore, full with a strange luminous material everywhere... Regardless, that means tons of extra cookies to get!',
            building: buildings.idleverse,
            tier,
        },
    ];
    ...
    HeavenlyUpgrades([
        {
            ...
            description:
                'Contains an assortment of cookies shaped like the buildings that produce those same cookies.',
        ...
        },
        {
            ...
            description:
                'The news ticker may occasionally have <b>misfortunes</b>, which may be clicked for "something".',
